...
# Problem 1
#####################
# Extract the data into a general data table from the csv file
...
#################
# Code
# Remove a variety of columns from the data table, this uses dplyr
...
# Part (a)
##############
## I know I could do a for loop here, but I want exact clarity
## In practice, I would use a for loop here
...
# Part (e)
##############
# The model with 300 trees was fond to be the most accurate at mtry = 2
